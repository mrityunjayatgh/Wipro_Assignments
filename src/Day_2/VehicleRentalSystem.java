...
class Customer2 {
    ...
    public Customer2(String customerId, String name) {
...
class Rental {
    ...
    public Rental(Vehicle vehicle, Customer2 customer, int daysRented) {
            ...
            switch (choice) {
                ...
                case 2:
                    ...
                    if (vehicleChoice >= 0 && vehicleChoice < vehicles.size() && !vehicles.get(vehicleChoice).isRented()) {
                        ...
                        Customer2 customer = new Customer2(customerId, customerName);
