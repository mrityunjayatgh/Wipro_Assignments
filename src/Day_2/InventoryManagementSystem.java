...
class Product1 {
    ...
    public Product1(String id, String name, int stock) {
        this.id = id;
        this.name = name;
        this.stock = stock;
    }
...
class Inventory implements Supplier {
    private Map<String, Product1> products = new HashMap<>();
    ...
    public void updateProductStock(String productId, int newStock) {
        Product1 product = products.get(productId);
        if (product != null) {
...
public class InventoryManagementSystem {
    public static void main(String[] args) {
        ...
        // Sample products
        Product1 product1 = new Product1("P001", "Laptop", 10);
        Product1 product2 = new Product1("P002", "Smartphone", 5);
        Product1 product3 = new Product1("P003", "Headphones", 2);
