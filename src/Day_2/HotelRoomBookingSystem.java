...
class Customer3 {
    ...
    public Customer3(String customerId, String name) {
...
class Booking {
    ...
    public Booking(Room room, Customer3 customer, int nights) {
        this.room = room;
            ...
            switch (choice) {
                ...
                case 2:
                    ...
                    if (roomChoice >= 0 && roomChoice < rooms.size() && !rooms.get(roomChoice).isBooked()) {
                        ...
                        selectedRoom.book();
                        Customer3 customer = new Customer3(customerId, customerName);
